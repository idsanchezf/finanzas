...
/**
 * Pagina de Login — OAuth2 con Google.
 *
 * Estados:
 * - idle: boton visible, esperando interaccion
 * - loading: prompt de Google abierto
 * - success: redirige al dashboard
 * - error: muestra mensaje, permite reintentar
 */
...
export default function AuthPage() {
  ...
  const { isAuthenticated, loading: isAuthLoading, loginWithGoogle } = useAuthContext();
  ...
  // ── Spinner mientras se verifica la sesion inicial ──────────────
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-lg font-medium text-gray-900">Inicio de sesion exitoso</p>
