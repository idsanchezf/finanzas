---
name: git-flow
description: Estrategia de branching Git Flow. Usar cuando se gestione el ciclo de ramas: feature/*, develop, release/*, hotfix/* y main. Cada feature se desarrolla en su propia rama. Independiente de tecnologia.
---
...
Git Flow es una estrategia de branching independiente de la tecnologia. Aplica a cualquier proyecto, sin importar el stack.
...
ci: configurar pipeline de despliegue
```
...
- Antes de mergear a `develop`, ejecutar tests y verificaciones de formato (los comandos dependen del stack definido en `docs/architecture.md`)
